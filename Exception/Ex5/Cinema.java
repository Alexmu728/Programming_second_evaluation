...
public class Cinema {
    ...
    public Cinema(String c_name, int numRooms) throws WrondDatadException {
            if(c_name.equals(" ")){
                throw new WrondDatadException("the name cannot be empty");
            }else if(numRooms<0){
                throw new WrondDatadException("The room introduced is wrong");
            }
            this.c_name=c_name;
